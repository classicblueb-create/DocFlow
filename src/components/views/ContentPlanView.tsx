...
import { Video, Sparkles, Loader2, Plus, X, Trash2, Calendar, Check, Copy, ChevronDown, ChevronUp, Clock, HelpCircle, Film, Radio, FileText, Send, Flame } from 'lucide-react';
                            ...
                            <div className="flex items-center gap-2 mt-1">
                              ...
                              {plan.scheduledDate && (
                                <span className="text-[9px] font-medium flex items-center gap-1 opacity-70">
                                  ...
                                  {new Date(plan.scheduledDate).toLocaleDateString("th-TH", { day: "numeric", month: "short" })}
                                </span>
                              )}
                            </div>
                          </div>
